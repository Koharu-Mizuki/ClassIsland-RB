...
public partial class App
{
    private void ConfigureServices(HostBuilderContext context, IServiceCollection services)
    {
        ...
        services.AddSingleton<OcrAiTimetableService>();
        ...
        services.AddProfileTransferProvider<OcrAiImportProvider>("classisland.profileTransfer.import.ocrAi", "AI 识图导入", ProfileTransferProviderType.Import, "");
